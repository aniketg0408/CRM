        ...
        {checks.map((c) => (
          <span
            ...
            style={{
              ...
              border: `1px solid ${c.ok ? "#0B5ED7" : "#DBEAFE"}`,
              background: c.ok ? "rgba(11,94,215,0.08)" : "transparent",
              color: c.ok ? "#0B5ED7" : "#94a3b8",
...
export function LoginModal({ open, onOpenChange, onLoginSuccess }: LoginModalProps) {
  ...
  const confirmShadow  = confirm.length === 0 ? "none"
    : passwordsMatch ? "0 0 0 3px rgba(134,239,172,0.2)" : "0 0 0 3px rgba(252,165,165,0.2)";
  ...
  /* ── Submit — wire up your own API calls in the TODO sections ── */
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isSignUp) {
      ...
      try {
        ...
        // e.g. await syncCustomer({ name, email, source: "CRM", password });
    ...
    setLoading(true);
    try {
      // TODO: connect sign-in API
      // e.g. const res = await loginCustomer({ email, password });
      // if (!res.success) throw new Error("Invalid credentials");
      // localStorage.setItem("user", JSON.stringify({ name: res.customer.name, email }));
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="p-0 border-0 shadow-2xl overflow-hidden sm:max-w-sm rounded-2xl">
        ...
        <style>{`
          .crm-header {
            background: linear-gradient(135deg, #1E88E5 0%, #0B5ED7 55%, #0D2244 100%);
          ...
          .crm-logo { display: flex; align-items: center; gap: 8px; margin-bottom: 12px; }
          ...
          .crm-card {
            ...
            border: 1px solid #DBEAFE; padding: 16px;
          ...
          .crm-input:focus {
            border-color: #0B5ED7; background: white;
          ...
          .crm-input::-ms-reveal,
          .crm-input::-ms-clear,
          .crm-input::-webkit-contacts-auto-fill-button,
          .crm-input::-webkit-credentials-auto-fill-button { display: none !important; }
          ...
          .crm-submit {
            ...
            box-shadow: 0 4px 14px rgba(11,94,215,0.35); letter-spacing: 0.01em;
          }
          ...
          .crm-toggle-btn {
            ...
            font-weight: 600; color: #0D2244; cursor: pointer; padding: 0;
          }
          ...
          <div className="crm-card">
            ...
            <form onSubmit={handleSubmit} autoComplete="off">
                ...
                <div className="crm-field">
                  ...
                  <div style={{ position: "relative" }}>
                    ...
                    <input
                      ...
                      autoComplete="off" className="crm-input" required
                    />
                  </div>
                </div>
              )}
              ...
              <div className="crm-field">
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input
                    ...
                    onChange={(e) => { setEmail(e.target.value); setHasError(false); setErrorMessage(""); }}
                    autoComplete="off"
                    className={`crm-input${hasError ? " err" : ""}`}
                    required
                  />
                </div>
              </div>
              ...
              <div className="crm-field" style={{ marginBottom: 0 }}>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input
                    ...
                    onChange={(e) => { setPassword(e.target.value); setHasError(false); setErrorMessage(""); }}
                    autoComplete="new-password"
                    className={`crm-input${hasError ? " err" : ""}`}
                    style={{ paddingRight: 34, WebkitAppearance: "none" } as React.CSSProperties}
                    required
                  />
                ...
                <div className="crm-field" style={{ marginTop: 12, marginBottom: 0 }}>
                  ...
                  <div style={{ position: "relative" }}>
                    ...
                    <input
                      ...
                      autoComplete="new-password" className="crm-input"
                      style={{
                        paddingRight: 34,
              ...
              <button type="submit" className="crm-submit" disabled={loading}>
                {loading
                  ? <><div className="crm-spinner" />Processing…</>
